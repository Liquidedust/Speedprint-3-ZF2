...
CREATE TABLE `categories` (
  ...
  `description_categories` text NOT NULL,
...
INSERT INTO `categories` VALUES (1,'Dekal & Dekor',1,2,NULL,'','n'),(2,'Mässa & Event',3,4,NULL,'','n'),(3,'Storformat',9,10,NULL,'','n'),(4,'Butik & Lokal',11,12,NULL,'','n'),(5,'Storformat',13,14,NULL,'','n'),(6,'Verktyg & Tillbehör',15,16,NULL,'','n'),(7,'Övrigt',26,27,NULL,'','n'),(8,'Diskar & Podium',7,8,NULL,'','n'),(9,'Montersystem',5,6,NULL,'','n'),(10,'Ramar',17,25,NULL,'','n'),(12,'Kilramar',18,19,NULL,'','n'),(13,'Tavelramar',23,24,NULL,'','n'),(14,'Passepartout',21,22,NULL,'','n');
...
CREATE TABLE `product_variants_rel` (
  ...
  CONSTRAINT `fk_product_variants_rel_pid` FOREIGN KEY (`id_products`) REFERENCES `products` (`id_products`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2013-12-04 14:25:10
